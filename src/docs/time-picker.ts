...
const doc: TagDoc.TagDocInstance = {
  ...
  attributes: [
    ...
    {
      name: 'readonly',
      description: { cn: 'whether TimePicker is read only', en: 'whether TimePicker is read only' },
      type: 'boolean',
      default: 'false',
      value: [],
    },
    {
      name: 'disabled',
      description: { cn: 'whether TimePicker is disabled', en: 'whether TimePicker is disabled' },
      type: 'boolean',
      default: 'false',
      value: [],
    },
    ...
    { name: 'size', description: { cn: 'size of Input', en: 'size of Input' }, type: 'string', default: '—', value: [] },
    { name: 'placeholder', description: { cn: 'placeholder in non-range mode', en: 'placeholder in non-range mode' }, type: 'string', default: '—', value: [] },
    {
      ...
      description: { cn: 'placeholder for the start time in range mode', en: 'placeholder for the start time in range mode' },
      type: 'string',
      default: '—',
      value: [],
    },
    {
      ...
      description: { cn: 'placeholder for the end time in range mode', en: 'placeholder for the end time in range mode' },
      type: 'string',
      default: '—',
      value: [],
    },
    { name: 'is-range', description: { cn: 'whether to pick a time range', en: 'whether to pick a time range' }, type: 'boolean', default: 'false', value: [] },
    {
      name: 'arrow-control',
    ...
    {
      name: 'popper-class',
      description: { cn: "custom class name for TimePicker's dropdown", en: "custom class name for TimePicker's dropdown" },
      type: 'string',
      default: '—',
      value: [],
    },
    ...
    {
      name: 'disabled-hours',
      description: { cn: 'To specify the array of hours that cannot be selected', en: 'To specify the array of hours that cannot be selected' },
      type: 'function',
      default: '—',
      value: [],
    },
    {
      ...
      description: { cn: 'To specify the array of minutes that cannot be selected', en: 'To specify the array of minutes that cannot be selected' },
    ...
    },
    {
      ...
      description: { cn: 'To specify the array of seconds that cannot be selected', en: 'To specify the array of seconds that cannot be selected' },
    ...
    {
      name: 'teleported',
      description: { cn: 'whether time-picker dropdown is teleported to the body', en: 'whether time-picker dropdown is teleported to the body' },
      type: 'boolean',
      default: 'true',
      value: [],
    },
  ...
  events: [
    ...
    {
      name: 'visible-change',
      description: { cn: "triggers when the TimePicker's dropdown appears/disappears", en: "triggers when the TimePicker's dropdown appears/disappears" },
      type: 'function',
      param: '',
    },
  ],
  exposes: [
    ...
    { name: 'handleOpen', description: { cn: 'open the TimePicker popper', en: 'open the TimePicker popper' }, type: 'function', param: '' },
    { name: 'handleClose', description: { cn: 'close the TimePicker popper', en: 'close the TimePicker popper' }, type: 'function', param: '' },
  ],
};
export default doc;
