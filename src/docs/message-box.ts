...
const doc: TagDoc.TagDocInstance = {
  ...
  attributes: [
    {
      name: '',
      description: { cn: 'auto focus when open MessageBox', en: 'auto focus when open MessageBox' },
      type: 'boolean',
      default: 'true',
      value: [],
    },
    {
      name: '',
      description: { cn: 'title of the MessageBox', en: 'title of the MessageBox' },
      type: 'string',
      default: '—',
      value: [],
    },
    {
      name: '',
      description: { cn: 'content of the MessageBox', en: 'content of the MessageBox' },
      type: '`string',
      default: '(() => VNode)`',
      value: [],
    },
    ...
    {
      name: '',
      description: { cn: 'custom class name for MessageBox', en: 'custom class name for MessageBox' },
      type: 'string',
      default: '—',
      value: [],
    },
    ...
    {
      name: '',
      description: { cn: 'whether to show a confirm button', en: 'whether to show a confirm button' },
      type: 'boolean',
      default: 'true',
      value: [],
    },
    {
      name: '',
      description: { cn: 'text content of cancel button', en: 'text content of cancel button' },
      type: 'string',
      default: 'Cancel',
      value: [],
    },
    {
      name: '',
      description: { cn: 'text content of confirm button', en: 'text content of confirm button' },
      type: 'string',
      default: 'OK',
      value: [],
    },
    {
      name: '',
      description: { cn: 'custom class name of cancel button', en: 'custom class name of cancel button' },
      type: 'string',
      default: '—',
      value: [],
    },
    ...
    {
      name: '',
      description: { cn: 'initial value of input', en: 'initial value of input' },
      type: 'string',
      default: '—',
      value: [],
    },
    {
      name: '',
      description: { cn: 'regexp for the input', en: 'regexp for the input' },
      type: 'regexp',
      default: '—',
      value: [],
    },
    ...
    {
      name: '',
      description: { cn: 'whether MessageBox is draggable', en: 'whether MessageBox is draggable' },
      type: 'boolean',
      default: 'false',
      value: [],
    },
    {
      name: '',
      description: { cn: 'whether to use round button', en: 'whether to use round button' },
      type: 'boolean',
      default: 'false',
      value: [],
    },
