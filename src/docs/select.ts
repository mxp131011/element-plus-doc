...
const doc: TagDoc.TagDocInstance = {
  ...
  attributes: [
    ...
    {
      name: 'multiple',
      description: { cn: 'whether multiple-select is activated', en: 'whether multiple-select is activated' },
      type: 'boolean',
      default: 'false',
      value: [],
    },
    { name: 'disabled', description: { cn: 'whether Select is disabled', en: 'whether Select is disabled' }, type: 'boolean', default: 'false', value: [] },
    {
      name: 'value-key',
      description: {
    ...
    },
    {
      name: 'multiple-limit',
      description: {
        cn: 'maximum number of options user can select when <code>multiple</code> is <code>true</code>. No limit when set to 0',
    ...
    { name: 'placeholder', description: { cn: 'placeholder', en: 'placeholder' }, type: 'string', default: 'Select', value: [] },
    {
      name: 'filterable',
      description: { cn: 'whether Select is filterable', en: 'whether Select is filterable' },
      type: 'boolean',
      default: 'false',
      value: [],
    },
    ...
    {
      name: 'remote',
      description: { cn: 'whether options are loaded from server', en: 'whether options are loaded from server' },
      type: 'boolean',
      default: 'false',
      value: [],
    },
    { name: 'remote-method', description: { cn: 'custom remote search method', en: 'custom remote search method' }, type: 'function', default: '—', value: [] },
    {
      name: 'remote-show-suffix',
      description: { cn: 'in remote search method show suffix icon', en: 'in remote search method show suffix icon' },
      type: 'boolean',
      default: 'false',
      value: [],
    },
    {
      name: 'loading',
      description: { cn: 'whether Select is loading data from server', en: 'whether Select is loading data from server' },
      type: 'boolean',
      default: 'false',
      value: [],
    },
    {
      name: 'loading-text',
      description: { cn: 'displayed text while loading data from server', en: 'displayed text while loading data from server' },
      type: 'string',
      default: 'Loading',
      value: [],
    },
    {
      name: 'no-match-text',
      description: {
        cn: 'displayed text when no data matches the filtering query, you can also use slot <code>empty</code>',
    ...
    },
    {
      name: 'no-data-text',
      description: {
        cn: 'displayed text when there is no options, you can also use slot <code>empty</code>',
    ...
    },
    {
      ...
      description: {
        cn: 'when <code>multiple</code> and <code>filter</code> is true, whether to reserve current keyword after selecting an option',
    ...
    },
    {
      ...
      description: {
        cn: 'select first matching option on enter key. Use with <code>filterable</code> or <code>remote</code>',
    ...
    { name: 'clear-icon', description: { cn: 'Custom clear icon component', en: 'Custom clear icon component' }, type: '`string', default: '—', value: [] },
    {
      ...
      description: { cn: 'whether the width of the dropdown is the same as the input', en: 'whether the width of the dropdown is the same as the input' },
      type: 'boolean',
      default: 'false',
      value: [],
    },
    { name: 'suffix-icon', description: { cn: 'Custom suffix icon component', en: 'Custom suffix icon component' }, type: '`string', default: '—', value: [] },
    {
      name: 'suffix-transition<deprecatedtag></deprecatedtag>',
      description: { cn: 'animation when dropdown appears/disappears icon', en: 'animation when dropdown appears/disappears icon' },
      type: 'boolean',
      default: 'true',
      value: [],
    },
    { name: 'tag-type', description: { cn: 'tag type', en: 'tag type' }, type: 'string', default: 'info', value: [] },
    {
      name: 'validate-event',
    ...
    { name: 'placement', description: { cn: 'position of dropdown', en: 'position of dropdown' }, type: 'string', default: 'bottom-start', value: [] },
    {
      ...
      description: {
        cn: 'The max tags number to be shown. To use this, <code>collapse-tags</code> must be true',
        en: 'The max tags number to be shown. To use this, <code>collapse-tags</code> must be true',
      },
      type: 'number',
      default: '1',
      value: [],
  ...
  events: [
    { name: 'change', description: { cn: 'triggers when the selected value changes', en: 'triggers when the selected value changes' }, type: '', tsType: '' },
    {
      name: 'visible-change',
  ...
  exposes: [
    ...
    {
      name: 'blur',
      description: { cn: 'blur the Input component, and hide the dropdown', en: 'blur the Input component, and hide the dropdown' },
      type: '',
      tsType: '',
    },
  ],
  slots: [
    { name: '—', description: { cn: 'Option component list', en: 'Option component list' } },
    { name: 'prefix', description: { cn: 'content as Select prefix', en: 'content as Select prefix' } },
    { name: 'empty', description: { cn: 'content when there is no options', en: 'content when there is no options' } },
  ],
};
export default doc;
