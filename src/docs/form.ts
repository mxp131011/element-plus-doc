...
const doc: TagDoc.TagDocInstance = {
  ...
  exposes: [
    ...
    { name: 'validateField', description: { cn: 'Validate specified fields.', en: 'Validate specified fields.' }, type: 'function', tsType: '' },
    {
      name: 'resetFields',
    ...
    { name: 'scrollToField', description: { cn: 'Scroll to the specified fields.', en: 'Scroll to the specified fields.' }, type: 'function', tsType: '' },
    {
      name: 'clearValidate',
