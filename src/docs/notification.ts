...
const doc: TagDoc.TagDocInstance = {
  ...
  attributes: [
    ...
    {
      name: '',
      description: { cn: 'description text', en: 'description text' },
    ...
    {
      name: '',
      description: { cn: 'notification type', en: 'notification type' },
      type: 'string',
      default: '—',
      value: [],
    },
    ...
    {
      name: '',
      description: { cn: 'custom class name for Notification', en: 'custom class name for Notification' },
      type: 'string',
      default: '—',
      value: [],
    },
    ...
    {
      name: '',
      description: { cn: 'custom position', en: 'custom position' },
      type: 'string',
      default: 'top-right',
      value: [],
    },
    ...
    {
      name: '',
      description: { cn: 'callback function when closed', en: 'callback function when closed' },
      type: 'function',
      default: '—',
      value: [],
    },
    ...
    {
      name: '',
      description: { cn: 'initial zIndex', en: 'initial zIndex' },
      type: 'number',
      default: '0',
      value: [],
    },
  ...
  exposes: [
    {
      name: '',
      description: { cn: 'close the Notification', en: 'close the Notification' },
      type: 'function',
      param: '',
    },
  ],
