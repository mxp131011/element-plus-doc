...
const doc: TagDoc.TagDocInstance = {
  ...
  events: [
    ...
    { name: 'blur', description: { cn: 'triggers when Cascader blurs', en: 'triggers when Cascader blurs' }, type: 'function', tsType: '' },
    { name: 'focus', description: { cn: 'triggers when Cascader focuses', en: 'triggers when Cascader focuses' }, type: 'function', tsType: '' },
    {
      name: 'visible-change',
  ...
  exposes: [
    ...
    { name: 'cascaderPanelRef', description: { cn: 'cascader panel ref', en: 'cascader panel ref' }, type: 'object', tsType: '' },
    {
