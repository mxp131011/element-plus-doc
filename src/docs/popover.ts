...
const doc: TagDoc.TagDocInstance = {
  ...
  events: [
    { name: 'show', description: { cn: 'triggers when popover shows', en: 'triggers when popover shows' }, type: '', tsType: '' },
    {
      name: 'before-enter',
    ...
    { name: 'hide', description: { cn: 'triggers when popover hides', en: 'triggers when popover hides' }, type: '', tsType: '' },
    {
      name: 'before-leave',
