...
const doc: TagDoc.TagDocInstance = {
  ...
  exposes: [
    { name: 'handleScroll', description: { cn: 'handle scroll event', en: 'handle scroll event' }, type: 'function', tsType: '' },
    {
      name: 'scrollTo',
    ...
    { name: 'setScrollTop', description: { cn: 'Set distance to scroll top', en: 'Set distance to scroll top' }, type: 'function', tsType: '' },
    { name: 'setScrollLeft', description: { cn: 'Set distance to scroll left', en: 'Set distance to scroll left' }, type: 'function', tsType: '' },
    { name: 'update', description: { cn: 'update scrollbar state manually', en: 'update scrollbar state manually' }, type: 'function', tsType: '' },
    { name: 'wrapRef', description: { cn: 'scrollbar wrap ref', en: 'scrollbar wrap ref' }, type: 'object', tsType: '' },
  ],
