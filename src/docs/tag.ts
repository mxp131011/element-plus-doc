...
const doc: TagDoc.TagDocInstance = {
  ...
  attributes: [
    ...
    {
      name: 'color',
      description: { cn: 'background color of the Tag', en: 'background color of the Tag' },
      type: 'string',
      default: '—',
      value: [],
    },
    {
      name: 'size',
      description: { cn: 'tag size', en: 'tag size' },
      type: 'enum',
      default: "'default'",
    ...
    {
      name: 'effect',
      description: { cn: 'component theme', en: 'component theme' },
      type: 'string',
      default: 'light',
      value: [],
    },
    {
      name: 'round',
      description: { cn: 'whether Tag is rounded', en: 'whether Tag is rounded' },
      type: 'boolean',
      default: 'false',
      value: [],
    },
  ...
  events: [
    {
      name: 'click',
      description: { cn: 'triggers when Tag is clicked', en: 'triggers when Tag is clicked' },
      type: 'function',
      param: '',
    },
    {
      name: 'close',
      description: { cn: 'triggers when Tag is removed', en: 'triggers when Tag is removed' },
      type: 'function',
      param: '',
    },
  ],
