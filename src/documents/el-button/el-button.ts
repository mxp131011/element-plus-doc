...
export const attributes: Document.Attribute[] = [
  {
    name: 'size',
...
export const slots: Document.Slot[] = [
  {
    name: 'default',
...
export const exposes: Document.Expose[] = [
  {
    name: 'ref',
...
export const documentInstance: Document.DocumentInstance = { attributes, slots, exposes };
