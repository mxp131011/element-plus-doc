...
const doc: TagDoc.TagDocInstance = {
  ...
  attributes: [
    ...
    {
      name: 'label',
      description: { cn: '与 RadioGroup 中的 aria-label 属性相同,用于无障碍访问', en: 'same as <code>aria-label</code> in RadioGroup' },
      type: 'string',
      default: '—',
      value: [],
    },
    {
      name: 'name',
      description: { cn: '原生 `name` 属性', en: 'native <code>name</code> attribute' },
      type: 'string',
      default: '—',
      value: [],
    },
