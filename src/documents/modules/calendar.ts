  ...
  slots: [
    {
      ...
      description: {
        ...
        en: "`type` indicates which month the date belongs, optional values are prev-month, current-month, next-month; `isSelected` indicates whether the date is selected; `day` is the formatted date in the format `YYYY-MM-DD`; `date` is date the cell represents. (parameter：{ data: { type: 'prev-month' &#124; 'current-month' &#124; 'next-month', isSelected: boolean, day: string, date: Date } })",
      },
    },
    {
      name: 'header',
