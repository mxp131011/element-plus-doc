...
const doc: TagDoc.TagDocInstance = {
  ...
  attributes: [
    ...
    {
      name: 'label',
      description: { cn: '等价于原生 input `label` 属性', en: 'same as <code>label</code> in native input' },
      type: 'string',
      default: '—',
      value: [],
    },
    {
      name: 'placeholder',
      description: { cn: '等价于原生 input `placeholder` 属性', en: 'same as <code>placeholder</code> in native input' },
      type: 'string',
      default: '—',
      value: [],
    },
