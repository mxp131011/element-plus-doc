      ...
      readLine.on("close", () => {
        Object.keys(document).forEach((key) => {
          ...
          if (document[key].attributes) {
            outStream.write(
              `import { DocumentAttribute } from "@/document";` + os.EOL
            );
          }
          if (document[key].methods) {
            outStream.write(
              `import { DocumentMethod } from "@/document";` + os.EOL
            );
          }
          if (document[key].events) {
            outStream.write(
              `import { DocumentEvent } from "@/document";` + os.EOL
            );
          }
          if (document[key].slots) {
            outStream.write(
              `import { DocumentSlot } from "@/document";` + os.EOL
            );
          }
          if (document[key].scopedSlots) {
            outStream.write(
              `import { DocumentScopedSlot } from "@/document";` + os.EOL
            );
          }
