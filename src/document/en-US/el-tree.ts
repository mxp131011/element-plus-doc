import type { DocumentAttribute, DocumentEvent, DocumentMethod, DocumentScopedSlot, ElDocument } from '@/types/index';
...
export const attributes: DocumentAttribute[] = [
  ...
  {
    name: 'disabled',
    description: "specify which key of node object represents if node's checkbox is disabled",
  ...
  {
    name: 'isLeaf',
    description: 'specify whether the node is a leaf node, only works when lazy load is enabled',
    type: 'boolean, function(data, node)',
    value: '—',
    default: '—',
  },
...
export const events: DocumentEvent[] = [
  {
    ...
    parameter: 'three parameters: node object corresponding to the node clicked, `node` property of TreeNode, TreeNode itself',
  },
  {
  ...
  },
  {
    ...
    parameter: 'two parameters: node object corresponding to the current node, `node` property of TreeNode',
  },
  {
    name: 'node-expand',
    description: 'triggers when current node open',
    parameter: 'three parameters: node object corresponding to the node opened, `node` property of TreeNode, TreeNode itself',
  },
  {
    name: 'node-collapse',
    description: 'triggers when current node close',
    parameter: 'three parameters: node object corresponding to the node closed, `node` property of TreeNode, TreeNode itself',
  },
  {
    name: 'node-drag-start',
    description: 'triggers when dragging starts',
    parameter: 'two parameters: node object corresponding to the dragging node, event.',
  },
  {
