import type { DocumentAttribute, DocumentMethod, DocumentSlot, ElDocument } from '@/types/index';
...
export const methods: DocumentMethod[] = [
  {
    name: 'clearFiles',
    description: 'clear the uploaded file list (this method is not supported in the `before-upload` hook)',
    parameter: '—',
  },
  {
    name: 'abort',
