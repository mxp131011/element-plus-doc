import type { DocumentAttribute, DocumentMethod, DocumentScopedSlot, DocumentSlot, ElDocument } from '@/types/index';
...
export const scopedSlots: DocumentScopedSlot[] = [
  {
    name: 'error',
    description: 'Custom content to display validation message. The scope parameter is { error }',
  },
];
