...
export const methods: DocumentMethod[] = [
  {
    ...
    parameter: '(leafOnly) whether only return the leaf checked nodes, default is `false`',
  },
  {
...
export const props = [
  ...
  {
    name: 'leaf',
    description: "specify which key of node object is used as the node's leaf field",
  },
];
