import type { DocumentAttribute, DocumentEvent, DocumentMethod, DocumentSlot, ElDocument } from '@/types/index';
...
export const attributes: DocumentAttribute[] = [
  ...
  },
  {
    ...
    description: 'Indicates should shadowing layer be insert into DocumentBody element',
    type: 'boolean',
    value: '—',
    default: 'true',
  },
  ...
  {
    name: 'visible',
    description: 'Should Drawer be displayed, also support the `.sync` notation',
    type: 'boolean',
    value: '—',
    default: 'false',
  },
  {
    ...
    description: 'Indicates whether user can close Drawer by clicking the shadowing layer.',
    type: 'boolean',
    value: '-',
    default: 'true',
  },
...
export const methods: DocumentMethod[] = [
  {
    name: 'closeDrawer',
    description: 'In order to close Drawer, this method will call `before-close`.',
    parameter: '',
  },
];
